...
class ZCycleViewCell: UICollectionViewCell {
    ...
    var titleContainerViewH: CGFloat = 40
    /// set text
    ...
    func addTitleLabel() {
        titleContainerView = UIView(frame: CGRect(x: 0, y: contentView.bounds.size.height-45, width: contentView.bounds.size.width, height: 45))
